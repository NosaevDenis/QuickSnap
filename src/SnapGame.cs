...
namespace CardGames
{
    public class SnapGame
    {
		...
		private static void HandleUserInput(Snap myGame)
		{
			...
			} else if (SwinGame.KeyTyped (KeyCode.vk_LSHIFT) && SwinGame.KeyTyped (KeyCode.vk_RSHIFT)) {
				SwinGame.LoadSoundEffectNamed ("slapS", "slapS.waw");
				SwinGame.PlaySoundEffect ("slapS");
			} else if (SwinGame.KeyTyped (KeyCode.vk_LSHIFT)) {
				myGame.PlayerHit (0);
				SwinGame.LoadSoundEffectNamed ("slap1", "slap1.waw");
				SwinGame.PlaySoundEffect ("slap1");
			} else if (SwinGame.KeyTyped (KeyCode.vk_RSHIFT)) {
				myGame.PlayerHit (1);
				SwinGame.LoadSoundEffectNamed ("slap2", "slap2.waw");
